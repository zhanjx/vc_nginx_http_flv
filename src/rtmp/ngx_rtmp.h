...
#define ngx_rtmp_get_module_ctx(s, module)   ((s)->ctx!=NULL?(s)->ctx[module.ctx_index]:NULL);
...
#define ngx_rtmp_get_module_main_conf(s, module)                             \
    (s)->main_conf != NULL ? (s)->main_conf[module.ctx_index]:NULL;
#define ngx_rtmp_get_module_srv_conf(s, module)  ((s)->srv_conf != NULL ? (s)->srv_conf[module.ctx_index]:NULL);
